...
def send_otp_via_viettel(phone):
    cookies = {
...
def send_otp_via_medicare(phone):
    cookies = {
        'SERVER': 'nginx2',
...
def send_otp_via_dienmayxanh(phone):
    cookies = {
...
def send_otp_via_kingfoodmart(phone):
    headers = {
        'accept': '*/*',
        'accept-language': 'vi,fr-FR;q=0.9,fr;q=0.8,en-US;q=0.7,en;q=0.6',
        'authorization': '',
...
def send_otp_via_fptmk(phone): # là quên pass ở fps á
    cookies = {
        'auth.strategy': '',
...
def send_otp_via_lottemart(phone):
...
def send_otp_via_DONGCRE(phone):
...
def send_otp_via_fptshop(phone):
    headers = {
        'accept': '*/*',
        'accept-language': 'vi,en-US;q=0.9,en;q=0.8',
...
def send_otp_via_WinMart(phone):
    headers = {
        'accept': 'application/json',
        'accept-language': 'vi,en-US;q=0.9,en;q=0.8',
...
def send_otp_via_vietloan(phone):
    cookies = {
...
def send_otp_via_vinpearl(phone):
...
def send_otp_via_traveloka(phone):
...
def send_otp_via_dongplus(phone):
...
def send_otp_via_longchau(phone):
...
def send_otp_via_longchau1(phone):
...
def send_otp_via_galaxyplay(phone):
...
def send_otp_via_emartmall(phone):
    cookies = {
...
def send_otp_via_ahamove(phone):
...
def send_otp_via_ViettelMoney(phone):
...
def send_otp_via_xanhsmsms(phone):
        # Kiểm tra và chuyển đổi số điện thoại
    if phone.startswith('09'):
        phone = '+84' + phone[1:]
...
def send_otp_via_xanhsmzalo(phone):
...
def send_otp_via_popeyes(phone):
...
def send_otp_via_ACHECKIN(phone):
    # Request 1
...
def send_otp_via_Watsons(phone):
...
def send_otp_via_hoangphuc(phone):
    cookies = {
...
def send_otp_via_fmcomvn(phone):
    headers = {
        'accept': 'application/json, text/plain, */*',
        'accept-language': 'vi,en-US;q=0.9,en;q=0.8',
...
def send_otp_via_Reebokvn(phone):
    headers = {
        'accept': 'application/json, text/plain, */*',
        'accept-language': 'vi',
        'content-type': 'application/json',
...
def send_otp_via_thefaceshop(phone):
    headers = {
        'accept': 'application/json, text/plain, */*',
        'accept-language': 'vi',
        'content-type': 'application/json',
...
def send_otp_via_BEAUTYBOX(phone):
    headers = {
        'accept': 'application/json, text/plain, */*',
        'accept-language': 'vi',
        'content-type': 'application/json',
...
def send_otp_via_futabus(phone):
...
def send_otp_via_ViettelPost(phone):
    headers = {
...
def send_otp_via_myviettel2(phone):
    headers = {
        'Accept': 'application/json, text/plain, */*',
        'Accept-Language': 'vi,en-US;q=0.9,en;q=0.8',
        'Connection': 'keep-alive',
...
def send_otp_via_myviettel3(phone):
    cookies = {
...
def send_otp_via_TOKYOLIFE(phone):
...
def send_otp_via_30shine(phone):
...
def send_otp_via_Cathaylife(phone):
    cookies = {
...
def send_otp_via_dominos(phone):
...
def send_otp_via_vinamilk(phone):
    headers = {
        'accept': '*/*',
        'accept-language': 'vi,en-US;q=0.9,en;q=0.8',
...
def send_otp_via_vietloan2(phone):
    cookies = {
...
def send_otp_via_batdongsan(phone):
    headers = {
        'accept': 'application/json, text/plain, */*',
        'accept-language': 'vi,en-US;q=0.9,en;q=0.8',
...
def send_otp_via_hopiness(phone):
    headers = {
        'Accept': '*/*',
        'Accept-Language': 'vi,en-US;q=0.9,en;q=0.8',
        'Connection': 'keep-alive',
...
def send_otp_via_modcha35(phone):
...
def send_otp_via_Routine(phone):
...
def send_otp_via_moneygo(phone):
...
def send_otp_via_TINIWORLD(phone):
    cookies = {
...
def send_otp_via_BACHHOAXANH(phone):
...
def send_otp_via_shbfinance(phone):
    headers = {
        'Accept': 'application/json',
        'Accept-Language': 'vi,en-US;q=0.9,en;q=0.8',
        'Authorization': 'Bearer',
...
def send_otp_via_mafccomvn(phone):
    cookies = {
        'pll_language': 'vi',
...
def send_otp_via_phuclong(phone):
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python dec .py <phone_number> <count>")
        sys.exit(1)
